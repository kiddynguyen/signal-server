...
import org.whisper.signal.entities.AccountCount;
import org.whisper.signal.entities.AttachmentUri;
import org.whisper.signal.entities.ClientContact;
import org.whisper.signal.entities.ClientContacts;
import org.whisper.signal.entities.IncomingMessageList;
import org.whisper.signal.federation.FederatedPeer;
import org.whisper.signal.federation.NonLimitedAccount;
...
public class FederationControllerV1 extends FederationController {
    ...
    public AttachmentUri getSignedAttachmentUri(@Auth FederatedPeer peer,
        @PathParam("attachmentId") long attachmentId) throws IOException {
