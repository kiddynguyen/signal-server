...
import org.whisper.signal.entities.IncomingMessage;
...
import org.whisper.signal.entities.SendMessageResponse;
import org.whisper.signal.entities.StaleDevices;
import org.whisper.signal.federation.FederatedClient;
import org.whisper.signal.federation.FederatedClientManager;
import org.whisper.signal.federation.NoSuchPeerException;
...
import org.whisper.signal.websocket.WebSocketConnection;
...
public class MessageController {
    ...
    public SendMessageResponse sendMessage(@Auth Account source,
        ...
        @Valid IncomingMessageList messages) throws IOException, RateLimitExceededException {
    ...
    private void sendRelayMessage(Account source, String destinationName, IncomingMessageList messages, boolean isSyncMessage)
        throws IOException, NoSuchUserException, InvalidDestinationException {
        if (isSyncMessage) {
            throw new InvalidDestinationException("Transcript messages can't be relayed!");
        }
