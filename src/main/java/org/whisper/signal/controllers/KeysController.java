...
import org.whisper.signal.storage.KeyRecord;
    ...
    public Optional<PreKeyResponse> getDeviceKeys(@Auth Account account,
        ...
        try {
            ...
            if (devices.isEmpty()) {
                ...
                return Optional.of(new PreKeyResponse(target.getIdentityKey(), devices));
            }
